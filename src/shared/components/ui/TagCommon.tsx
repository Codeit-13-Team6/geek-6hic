...
/**
 * 예시)
 * <TagCommon variant="blue" size="lg">오늘 21시 마감</TagCommon>
 * <TagCommon variant="white" size="sm">17:30</TagCommon>
 * <TagCommon variant="blue" className="font-bold opacity-80">D-Day</TagCommon>
 */
