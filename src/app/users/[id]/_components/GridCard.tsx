...
export default function GradeCard({ userType }: GradeCardProps) {
  ...
  return (
    <div
      className={cn(
        "relative flex h-full w-full flex-col overflow-hidden rounded-4xl border border-slate-100 p-7 text-indigo-950 shadow-md transition-all duration-700 md:max-lg:min-h-90",
        character.bgClass,
      )}
    >
      {/* 1. 배경 장식: COGIT */}
      ...
      <div className="relative z-10 my-5 mt-7 flex flex-col gap-4 md:flex-1 md:flex-row md:items-center md:gap-5 lg:flex-col">
        {/* 3. 중앙 캐릭터 영역 (워터마크 마스킹) */}
        <div className="relative flex h-48 items-center justify-center overflow-hidden rounded-2xl md:w-1/2 md:shrink-0 lg:w-full">
          <img
        ...
        <div className="relative z-20 flex flex-col items-center border-t border-indigo-950/5 pt-4 text-center md:h-full md:flex-1 md:items-start md:justify-center md:border-t-0 md:border-l md:pt-0 md:pl-5 md:text-left lg:items-center lg:border-t lg:border-l-0 lg:pt-4 lg:pl-0 lg:text-center">
