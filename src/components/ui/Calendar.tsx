...
function Calendar({
  ...
  return (
      <div className="z-20 absolute lg:top-full left-0 -translate-x-1/2 lg:translate-x-0 box-border w-[300px] rounded-[12px] border border-gray-100 bg-white p-6 shadow-[0_10px_10px_-5px_rgba(0,0,0,0.04)]">
        <DayPicker
